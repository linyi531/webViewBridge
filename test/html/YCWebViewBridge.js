(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["YCWebViewBridge"] = factory();
	else
		root["YCWebViewBridge"] = factory();
...
var _remove2 = __webpack_require__(6);
...
var _fp = __webpack_require__(16);
...
var YCEvent = function () {
  ...
  _createClass(YCEvent, [{
    ...
    value: function emit(eventName) {
      ...
      if ((0, _validation.getType)(eventName) !== 'string') return 0;
      if ((0, _validation.getType)(this.cache[eventName]) !== 'array') return 0;
      var funcs = this.cache[eventName];
...
exports.CALL_NATIVE_KEY = exports.ANDROID_JAVASCRIPT_INTERFACE_OBJECT_NAME = undefined;
exports.getInterfaceObject = getInterfaceObject;
exports.getBridgeParameter = getBridgeParameter;
...
var ANDROID_JAVASCRIPT_INTERFACE_OBJECT_NAME = exports.ANDROID_JAVASCRIPT_INTERFACE_OBJECT_NAME = 'YCJSBridge';
var CALL_NATIVE_KEY = exports.CALL_NATIVE_KEY = 'evaluateJava';

function getInterfaceObject(callback) {
  var interfaceObject = window.YCJSBridge; // 使用 [] 获取 bridge 引用方式会报异常
  var isExist = (0, _validation.getType)(interfaceObject) === 'object';
  if (isExist) {
...
function getBridgeParameter(eventName, params) {
  var dispatchId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'NOOP';

  if ((0, _validation.isEmpty)(eventName)) {
    console.error('eventName must be a string and not empty');
    return;
  }
  var data = {};
  if ((0, _validation.getType)(params) === 'object') data = params;
  return {
    eventName: eventName,
    params: data,
...
function decodeData(base64Str) {
  if ((0, _validation.getType)(base64Str) === 'string' && !(0, _validation.isEmpty)(base64Str)) {
    var jsonStr = _jsBase.Base64.decode(base64Str);
    var json = JSON.parse(jsonStr);
    return json;
  } else {
    var err = 'decodeData is not a string';
    console.error(err);
    return { err: err };
  }
}

function encodeData(jsonObj) {
  if ((0, _validation.getType)(jsonObj) === 'object' && !(0, _validation.isEmpty)(jsonObj)) {
    var jsonStr = JSON.stringify(jsonObj);
    var base64Str = _jsBase.Base64.encode(jsonStr);
    return base64Str;
  } else {
    var err = 'encodeData is not a json object';
    console.error(err);
    return err;
  }
}
...
var _defaultBridge = __webpack_require__(5);

var _defaultBridge2 = _interopRequireDefault(_defaultBridge);

var _androidV2Bridge = __webpack_require__(19);

var _androidV2Bridge2 = _interopRequireDefault(_androidV2Bridge);

var _android = __webpack_require__(2);
...
function initBridge() {
  var bridge = null;
  (0, _android.getInterfaceObject)(function (err, interfaceObj) {
    if (err) {
      bridge = _defaultBridge2.default;
    } else {
      bridge = _androidV2Bridge2.default;
    }
  });
  return bridge;
}

var YCWebViewBridge = initBridge();
...
var noopData = { ok: true, data: { signal: 'noop' } };
...
var YCWebViewBridge = function () {
  ...
  _createClass(YCWebViewBridge, [{
    ...
    value: function ready(callback) {
      _bridge2.default.ready(callback);
    }
  }, {
    key: 'on',
    value: function on(eventName, callback) {
      ...
      this.ready(function (bridge) {
        ...
        bridge.registerHandler(eventName, function (data, responseCallback) {
    ...
    key: 'callNative',
    value: function callNative(eventName, data) {
      var callback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function () {};

      var callData = data;
      var callHandler = callback;
      if ((0, _validation.getType)(data) === 'function') {
        callData = noopData;
        callHandler = data;
      } else if (!data) {
        callData = noopData;
...
var baseIteratee = __webpack_require__(7),
    basePullAt = __webpack_require__(8);
...
var baseUnset = __webpack_require__(9),
...
var castPath = __webpack_require__(10),
    last = __webpack_require__(12),
    parent = __webpack_require__(13),
...
var CALLBACK_EVENTS_NAMESPANCE = '__callbackEmiter';

var YCAndroidWebViewBridge = function () {
  function YCAndroidWebViewBridge(namespance) {
    _classCallCheck(this, YCAndroidWebViewBridge);

    this.events = new _YCEvent2.default(namespance);
    this.callbackEmiter = new _YCEvent2.default(CALLBACK_EVENTS_NAMESPANCE);
    console.log(namespance);
    window.__YCBridge__ = {
  ...
  _createClass(YCAndroidWebViewBridge, [{
    key: 'on',
    value: function on(eventName, callback) {
    ...
    value: function callNative(eventName, data, callback) {
      ...
      (0, _android.getInterfaceObject)(function (err, jsBridge) {
        if (err) {
        ...
        var params = void 0;
        var callNativeFunction = window.YCJSBridge.evaluateJava;
        /**
        ...
        if (typeof callback !== 'function') {
          params = (0, _android.getBridgeParameter)(eventName, data);
        } else {
          var dispatchId = eventName + '_' + (0, _uuid2.default)();
          _this.callbackEmiter.once(dispatchId, function (data) {
            callback(data);
          });
          params = (0, _android.getBridgeParameter)(eventName, data, dispatchId);
        }
        console.log((0, _android.encodeData)(params));
        _this.__AndroidEvaluateJava(params);
      });
    }
  }, {
    key: '_YCDispatch',
    value: function _YCDispatch(data) {
      var _this2 = this;

      var dataObj = (0, _android.decodeData)(data);
      var eventName = dataObj.eventName,
          _dataObj$params = dataObj.params,
          params = _dataObj$params === undefined ? {} : _dataObj$params,
          dispatchId = dataObj.dispatchId;
      ...
      if (dispatchId !== 'NOOP') {
        ...
        callback = function callback(data) {
          var param = (0, _android.getBridgeParameter)(eventName, data, dispatchId);
          _this2.__AndroidResponseCallback(param);
        };
      }
      var effectCount = this.events.emit(eventName, params, callback);
      console.log('effectCount:', effectCount);
      if (effectCount === 0) {
        // 如果受影响数量为 0 ，则证明没有这个事件
        // 给 native 返回错误信息
        var dontRegisterData = { ok: false, errCode: 404 };
        var param = (0, _android.getBridgeParameter)(eventName, dontRegisterData, dispatchId);
        console.log('effectData:', param);
        this.__AndroidResponseCallback(param);
      }
    }
  }, {
    key: '_YCResponseCallback',
    value: function _YCResponseCallback(data) {
      var dataObj = (0, _android.decodeData)(data);
      var eventName = dataObj.eventName,
          _dataObj$params2 = dataObj.params,
          params = _dataObj$params2 === undefined ? {} : _dataObj$params2;

      this.callbackEmiter.emit(eventName, params);
    }
  }, {
    key: '__AndroidResponseCallback',
    value: function __AndroidResponseCallback(data) {
      var params = (0, _android.encodeData)(data);
      window.YCJSBridge.responseCallback(params);
    }
  }, {
    key: '__AndroidEvaluateJava',
    value: function __AndroidEvaluateJava(data) {
      var params = (0, _android.encodeData)(data);
      window.YCJSBridge.evaluateJava(params);
    }
  }]);

  return YCAndroidWebViewBridge;
}();

exports.default = YCAndroidWebViewBridge;
